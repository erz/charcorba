	...
	implements Standard
{
	...
	public boolean signal_tableaublanc(java.lang.String tableau, int idpixel)
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.signal_tableaublanc(tableau,idpixel);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public boolean signal_chatroom(java.lang.String chatroom, int idpixel)
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.signal_chatroom(chatroom,idpixel);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public boolean inviter_client_chatroom(java.lang.String chatroom)
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.inviter_client_chatroom(chatroom);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public boolean inviter_client_tableaublanc(java.lang.String tableau)
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.inviter_client_tableaublanc(tableau);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void sendc_signal_tableaublanc(AMI_StandardHandler ami_handler, java.lang.String tableau, int idpixel)
	{
		while(true)
		{
			try
	...
	public void sendc_signal_chatroom(AMI_StandardHandler ami_handler, java.lang.String chatroom, int idpixel)
	{
		while(true)
		{
			try
	...
	public void sendc_inviter_client_chatroom(AMI_StandardHandler ami_handler, java.lang.String chatroom)
	{
		while(true)
		{
			try
	...
	public void sendc_inviter_client_tableaublanc(AMI_StandardHandler ami_handler, java.lang.String tableau)
	{
		while(true)
		{
			try
