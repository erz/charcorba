	...
	implements org.omg.CORBA.portable.InvokeHandler, StandardOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "signal_tableaublanc", new java.lang.Integer(3));
		m_opsHash.put ( "signal_chatroom", new java.lang.Integer(4));
	}
