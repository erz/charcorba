...
CORBA::Boolean Standard_stub::inviter_client_chatroom( const char* _par_chatroom )
{
  CORBA::StaticAny _sa_chatroom( CORBA::_stc_string, &_par_chatroom );
  CORBA::Boolean _res;
  CORBA::StaticAny __res( CORBA::_stc_boolean, &_res );

  CORBA::StaticRequest __req( this, "inviter_client_chatroom" );
  __req.add_in_arg( &_sa_chatroom );
  __req.set_result( &__res );
...
CORBA::Boolean
Standard_stub_clp::inviter_client_chatroom( const char* _par_chatroom )
{
  PortableServer::Servant _serv = _preinvoke ();
  if (_serv) {
    POA_Standard * _myserv = POA_Standard::_narrow (_serv);
    if (_myserv) {
      ...
      try {
      #endif
        __res = _myserv->inviter_client_chatroom(_par_chatroom);
      #ifdef HAVE_EXCEPTIONS
      }
      catch (...) {
        _myserv->_remove_ref();
  ...
  return Standard_stub::inviter_client_chatroom(_par_chatroom);
}

#endif // MICO_CONF_NO_POA

CORBA::Boolean Standard_stub::inviter_client_tableaublanc( const char* _par_tableau )
{
  CORBA::StaticAny _sa_tableau( CORBA::_stc_string, &_par_tableau );
  CORBA::Boolean _res;
  CORBA::StaticAny __res( CORBA::_stc_boolean, &_res );

  CORBA::StaticRequest __req( this, "inviter_client_tableaublanc" );
  __req.add_in_arg( &_sa_tableau );
  __req.set_result( &__res );
...
CORBA::Boolean
Standard_stub_clp::inviter_client_tableaublanc( const char* _par_tableau )
{
  PortableServer::Servant _serv = _preinvoke ();
  if (_serv) {
    POA_Standard * _myserv = POA_Standard::_narrow (_serv);
    if (_myserv) {
      ...
      try {
      #endif
        __res = _myserv->inviter_client_tableaublanc(_par_tableau);
      #ifdef HAVE_EXCEPTIONS
      }
      catch (...) {
        _myserv->_remove_ref();
  ...
  return Standard_stub::inviter_client_tableaublanc(_par_tableau);
}
...
POA_Standard::dispatch (CORBA::StaticServerRequest_ptr __req)
{
  ...
  try {
    ...
    case 0:
      if( strcmp( __req->op_name(), "inviter_client_chatroom" ) == 0 ) {
        ...
        _res = inviter_client_chatroom( _par_chatroom.inout() );
        __req->write_results();
        return true;
      }
      break;
    case 2:
      if( strcmp( __req->op_name(), "inviter_client_tableaublanc" ) == 0 ) {
        ...
        _res = inviter_client_tableaublanc( _par_tableau.inout() );
        __req->write_results();
        return true;
      }
      break;
