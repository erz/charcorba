...
_delegate.ping_excep(excep_holder);
	...
	{
_delegate.inviter_client_tableaublanc(ami_return_val);
	}
...
_delegate.ping(ami_return_val);
	...
	{
_delegate.signal_tableaublanc_excep(excep_holder);
	}

	public void inviter_client_tableaublanc_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
_delegate.inviter_client_tableaublanc_excep(excep_holder);
	}

	public void signal_tableaublanc(boolean ami_return_val)
	{
_delegate.signal_tableaublanc(ami_return_val);
	}
...
_delegate.afficher_message(ami_return_val);
	...
	{
_delegate.inviter_client_chatroom(ami_return_val);
	}
...
_delegate.signal_chatroom_excep(excep_holder);
	...
	{
_delegate.inviter_client_chatroom_excep(excep_holder);
	}
