	...
	implements org.omg.CORBA.portable.InvokeHandler, StandardOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "signal_tableaublanc", new java.lang.Integer(2));
		m_opsHash.put ( "signal_chatroom", new java.lang.Integer(3));
		m_opsHash.put ( "inviter_client_chatroom", new java.lang.Integer(4));
		m_opsHash.put ( "inviter_client_tableaublanc", new java.lang.Integer(5));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 2: // signal_tableaublanc
			{
				java.lang.String _arg0=_input.read_string();
				int _arg1=_input.read_ulong();
				_out = handler.createReply();
				_out.write_boolean(signal_tableaublanc(_arg0,_arg1));
				break;
			}
			case 3: // signal_chatroom
			{
				...
				int _arg1=_input.read_ulong();
				_out = handler.createReply();
				_out.write_boolean(signal_chatroom(_arg0,_arg1));
				break;
			}
			case 4: // inviter_client_chatroom
			{
				java.lang.String _arg0=_input.read_string();
				_out = handler.createReply();
				_out.write_boolean(inviter_client_chatroom(_arg0));
				break;
			}
			case 5: // inviter_client_tableaublanc
			{
				java.lang.String _arg0=_input.read_string();
				_out = handler.createReply();
				_out.write_boolean(inviter_client_tableaublanc(_arg0));
				break;
			}
		}
		return _out;
