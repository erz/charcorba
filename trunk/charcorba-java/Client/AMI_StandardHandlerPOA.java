	...
	implements org.omg.CORBA.portable.InvokeHandler, AMI_StandardHandlerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "signal_tableaublanc_excep", new java.lang.Integer(2));
		m_opsHash.put ( "inviter_client_excep", new java.lang.Integer(3));
		m_opsHash.put ( "signal_tableaublanc", new java.lang.Integer(4));
		m_opsHash.put ( "afficher_message", new java.lang.Integer(5));
		m_opsHash.put ( "signal_chatroom_excep", new java.lang.Integer(6));
		m_opsHash.put ( "inviter_client", new java.lang.Integer(7));
		m_opsHash.put ( "signal_chatroom", new java.lang.Integer(8));
		m_opsHash.put ( "afficher_message_excep", new java.lang.Integer(9));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 2: // signal_tableaublanc_excep
			{
				org.omg.Messaging.ExceptionHolder _arg0=(org.omg.Messaging.ExceptionHolder)((org.omg.CORBA_2_3.portable.InputStream)_input).read_value ("IDL:omg.org/Messaging/ExceptionHolder:1.0");
				_out = handler.createReply();
